# Public Source Registry — Melosa Clínica Brugal

## Purpose

This registry records the public sources used during the initial research and branding phase. A source appearing here does not mean that every statement on that source is current or accurate. The intended use and known limitations are documented.

Before launch, time-sensitive operational information should be replaced or confirmed by client-approved data.
...
## 1. Current institutional website

**URL:** https://clinicabrugalmejia.ig-techx.com/
...
## 2. Institutional “Nosotros” / history page

**URL:** https://clinicabrugalmejia.ig-techx.com/nosotros.html
...
## 3. Institutional services page

**URL:** https://clinicabrugalmejia.ig-techx.com/servicios.html
...
## 4. Cámara de Comercio y Producción de Puerto Plata

**URL:** https://www.camarapuertoplata.org/socio/1478
...
## 5. DGII — Dominican tax authority

**Base domain:** https://dgii.gov.do/
...
## 6. Puerto Plata destination / medical-center information

**URL:** https://www.puertoplatadr.com/gov/emergency/medical-centers/
...
## 8. Puerto Plata Digital — local historical material

**Base domain:** https://puertoplatadigital.com/
...
## 9. Diario Libre — 2020 cardiovascular milestone

**URL:** https://www.diariolibre.com/actualidad/colocan-el-primer-dispositivo-intracardiaco-en-clinica-brugal-mejia-lopez-de-puerto-plata-IB22235397
...
## 10. CDN — cardiovascular milestone

**URL:** https://cdn.com.do/nacionales/colocan-primer-dispositivo-intracardiaco-en-puerto-plata-en-la-clinica-brugal-mejia-lopez/
...
## 11. Bupa provider directory

**URL:** https://contenidos.bupasalud.com/en/melosa-cl%C3%ADnica-brugal-srl
...
## 12. Journal de Québec — 2024 external reporting

**URL:** https://www.journaldequebec.com/2024/01/13/des-soins-de-sante--securisants
...
## 13. Municipal / SISMAP documentation

**Base domain:** https://www.sismap.gob.do/

A 2025 municipal document reviewed during research referenced an annex of a two-level building for Melosa Clínica Brugal SRL.
...
## 14. Institutional Azure-hosted content

**URL:** https://clinicabrugal.azurewebsites.net/
...
## 15. Dr. Eliany Mejía López professional site

**URL:** https://elianymejia.com/
...
## 16. Instagram — Melosa Clínica Brugal

**URL:** https://www.instagram.com/melosaclinicabrugal/
...
## 17. Facebook — Melosa Clínica Brugal

**URL:** https://www.facebook.com/melosaclinicabrugal/
...
## 18. Centro Cardiovascular social presence

**URL:** https://www.instagram.com/centrocardiodr.mejia/
...
## 19. YouTube institutional video

**URL:** https://www.youtube.com/watch?v=lPsyK0cSU40
...
## 20. Physician directories

Research also used physician-directory entries such as BuscaMed to identify possible doctors historically/currently associated with Melosa Clínica Brugal and physician-level insurer relationships.
...
# Source-of-truth priority for production

Use this priority order when sources conflict:

1. Client-approved current institutional data.
2. Current official legal/regulatory records where relevant.
3. Approved internal historical documents.
4. Current institutional public channels.
5. High-quality independent press.
6. Third-party directories.
7. Social posts and discovery sources.

Historical disputes should be documented rather than silently resolved by choosing the most convenient date.
